...
if __name__ == '__main__':
    ...
    #
    s="train.py /home/tilo/data/asr_data/fairseq_preprocessed_librispeech --num-workers 0 --train-subset valid --log-format simple --max-epoch 8 --task speech_recognition --arch asr_transformer --optimizer adam --lr 0.0001 --clip-norm 10.0 --batch-size 2 --log-interval 100 --criterion cross_entropy_acc --user-dir /home/tilo/code/SPEECH/fairseq-speech-recognition/speech_recognition"
